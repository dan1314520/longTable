let CreatedOKLodop7766 = null; let CLodopIsLocal
...
export const getLodop = (oOBJECT, oEMBED) => {
  const strHtmInstall = "<br><font color='#FF00FF'>打印控件未安装!点击这里<a href='/static/data/CLodop_Setup_for_Win32NT' target='_self'>执行安装</a>,安装后请刷新页面或重新进入。</font>"
  ...
  const strCLodopInstall_1 = "<br><font color='#FF00FF'>Web打印服务CLodop未安装启动，点击这里<a href='/static/data/CLodop_Setup_for_Win32NT.exe' target='_self'>下载执行安装</a>"
